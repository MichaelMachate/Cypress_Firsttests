// ======================================================================
// FirstTestMutal.v generated from TopDesign.cysch
// 08/03/2018 at 10:08
...
module CapSense_P4_v5_20_2 ;
	...
	wire [5:0] tmpOE__Rx_net;
	wire [5:0] tmpFB_5__Rx_net;
	wire [5:0] tmpIO_5__Rx_net;
	wire [0:0] tmpINTERRUPT_0__Rx_net;
	electrical [0:0] tmpSIOVREF__Rx_net;

	cy_psoc3_pins_v1_10
		#(.id("984312c2-f862-4f33-b71b-f98e6bebf76b/ea884bc0-86af-40f9-b67b-efbe1ecd0ccd"),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("Button0_Rx0,Button1_Rx0,Button2_Rx0,Button3_Rx0,Button4_Rx0,Button5_Rx0"),
		  .pin_mode("AAAAAA"),
		  .por_state(4),
		  .sio_group_cnt(0),
		...
		Rx
		 (.oe(tmpOE__Rx_net),
		  .y({6'b0}),
		  .fb({tmpFB_5__Rx_net[5:0]}),
		  .analog({Net_13[5:0]}),
		  .io({tmpIO_5__Rx_net[5:0]}),
	...
	assign tmpOE__Rx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("984312c2-f862-4f33-b71b-f98e6bebf76b/a0d51a89-431d-48d5-b6fc-22184503fde4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("984312c2-f862-4f33-b71b-f98e6bebf76b/458c2b64-f6c8-403c-9883-825f70cb5346"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("984312c2-f862-4f33-b71b-f98e6bebf76b/9696e4af-6170-4a72-adbc-8a1b5950a8a9"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    CapSense_P4_v5_20_2 CapSense_1 ();
	...
	cy_psoc3_pins_v1_10
		#(.id("097f1629-ce74-4dea-abda-b425813b0068"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c74671d6-70e8-49ff-90ae-cfdbda7a3b04"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1eeb1c72-d89f-4ab6-a189-ecbb82f483b6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6f1b25ea-c78d-456a-b241-dc42aac7cebf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c94474cf-06cf-4ae9-b7dc-f8b6d1d4b365"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
